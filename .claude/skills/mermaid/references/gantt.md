...
As shown here ![Gantt chart with excluded days extending the task duration](./img/Gantt-excluded-days-within.png)

However, if the excluded dates are between two tasks that are set to start consecutively, the excluded dates will be skipped graphically and left blank, and the following task will begin after the end of the excluded dates.
As shown here ![Gantt chart showing gap between tasks with excluded dates](./img/Gantt-long-weekend-look.png)
